...
def clean_duplicate_logs(apps, schema_editor):
    ...
    for log_entry in LogEntry.objects.all():
        ...
        to_delete = LogEntry.objects.filter(
            ...
            (Q(site=log_entry.site) if log_entry.site else Q(
                site__isnull=True)) &
            (Q(section=log_entry.section) if log_entry.section else Q(
                section=log_entry.section)) &
            (Q(subsection=log_entry.subsection) if log_entry.subsection else Q(
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(clean_duplicate_logs),
