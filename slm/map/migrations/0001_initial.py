    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('map_style', slm.map.fields.MapBoxStyleField(blank=True, choices=[('streets', 'Streets'), ('outdoors', 'Outdoors'), ('light', 'Light'), ('dark', 'Dark'), ('satellite', 'Satellite'), ('satellite-streets', 'Satellite Streets'), ('navigation-day', 'Navigation Day'), ('navigation-night', 'Navigation Night')], default='light', help_text='The map tile styling to use.', max_length=17)),
                ('map_projection', slm.map.fields.MapBoxProjectionField(blank=True, choices=[('albers', 'Albers'), ('equalEarth', 'Equal Earth'), ('equirectangular', 'Equi-Rectangular'), ('lambertConformalConic', 'Lambert Conformal Conic'), ('mercator', 'Mercator'), ('naturalEarth', 'Natural Earth'), ('winkelTripel', 'Winkel Tripel'), ('globe', 'Globe')], default='globe', help_text='The map projection to use.', max_length=21)),
