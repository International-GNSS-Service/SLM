...
class EquipmentState(IntegerChoices, p('help_text')):
    ...
    LEGACY =     101, _('Legacy'),     _('This equipment is not in active use or its coding has changed.')
    UNVERIFIED = 102, _('Unverified'), _('This equipment information has not been vetted.')
