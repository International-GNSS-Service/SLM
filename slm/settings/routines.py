...
routine(
    'deploy',
    _('Run collection of commands that likely need to be run whenever code is updated.'),
    switch_helps={
        'initial': _("Run collection of commands that should only be run on the first deployment.")
    }
)
